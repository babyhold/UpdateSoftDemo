 ...
 * @2014-5-6
 */
public class FilePartDownloadThread extends Thread {
     ...
     * @param threadId:线程ID
     */
    public FilePartDownloadThread(URL downloadUrl, File file, int blocksize,
                              int threadId) {
    ...
    public void run() {
        ...
        try {
            ...
            File apkPartFile = new File(file.getPath()+".part"+String.valueOf(threadId));
            FileOutputStream fos = new FileOutputStream(apkPartFile);
